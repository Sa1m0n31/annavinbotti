...
router.get('/', (request, response) => {
   ...
   if(id) {
       const query = `SELECT o.id, o.date, u.first_name, u.last_name, u.email, u.phone_number, o.shipping,
                    ...
                    ua.flat as user_flat, o.nip, o.company_name, p.name_pl as product_name, p.name_en as product_name_en, s.price, t.name_pl as type, t.id as type_id,
                    ...
                    LEFT OUTER JOIN sells_addons sa ON s.id = sa.sell 
                    ...
                    LEFT OUTER JOIN addons_options ao ON sa.option = ao.id 
                    LEFT OUTER JOIN addons a ON ao.addon = a.id 
