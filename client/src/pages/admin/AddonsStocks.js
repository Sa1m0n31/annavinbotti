...
import {deleteAddon, deleteType, getAllAddonsOptions, getAllProducts, getAllTypes} from "../../helpers/products";
...
import AddonStockListItem from "../../components/admin/AddonStockListItem";

const AddonsStocks = ({type}) => {
        ...
        <div className="admin">
            ...
            <main className="admin__main">
                <h2 className="admin__main__header">
                    Edycja stanów magazynowych dodatków
                </h2>
                {stocks?.map((item, index) => {
                    return <AddonStockListItem index={index}
                                                 id={item.id}
