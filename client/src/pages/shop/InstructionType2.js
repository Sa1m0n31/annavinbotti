...
import i31 from '../../static/img/i31.jpg'
import i32 from '../../static/img/i32.JPG'
import i33 from '../../static/img/i33.JPG'
import i34 from '../../static/img/i34.JPG'
import i35 from '../../static/img/i35.JPG'
import i36 from '../../static/img/i36.JPG'
import i37 from '../../static/img/i37.JPG'
import i38 from '../../static/img/i38.jpg'
import i39 from '../../static/img/i39.jpg'
import i40 from '../../static/img/i40.jpg'
import i41 from '../../static/img/i41.jpg'
import i42 from '../../static/img/i42.jpg'
import i43 from '../../static/img/i43.jpg'
import i44 from '../../static/img/i44.JPG'
import i45 from '../../static/img/i45.JPG'

const InstructionType2 = () => {
    return <div className="container">
        ...
        <main className="page w">
            ...
            <article className="page__content page__content--instruction">
                ...
                <p className="bold">
                    Miary wyznaczamy po zewnętrznej stronie łydki i kostki.
                </p>
                <p>
                    Rekomendujemy poprosić kogoś o pomoc przy wyznaczaniu poniższych obwodów.
                </p>

                <div className="page__images">
                    <img className="img" src={i31} alt="instrukcja" />
                </div>

                <p>
                    13) G – Obwód nad kostką
                </p>
                <p className="m1">
                    a) Wyznaczamy punkt nad kostką
                </p>
                <div className="page__images m1">
                    <img className="img" src={i32} alt="instrukcja" />
                </div>
                <p className="m1">
                    b) Centymetrem krawieckim mierzymy obwód w miejscu wyznaczonym w poprzednim punkcie (13a)
                </p>
                <div className="page__images m1">
                    <img className="img" src={i33} alt="instrukcja" />
                </div>
                <p className="m1">
                    c) Wykonujemy zdjęcie telefonem (analogicznie do powyższego zdjęcia z punktu 13b)
                </p>

                <p>
                    14) H – Wysokość stopy nad kostką
                </p>
                <p className="m1">
                    a) Mierzymy wysokość od pięty do miejsca nad kostką  (miejsca wyznaczonego w punkcie 13a niniejszej instrukcji)
                </p>
                <div className="page__images m1">
                    <img className="img" src={i34} alt="instrukcja" />
                </div>
                <p className="m1">
                    b) Wykonujemy zdjęcie telefonem (analogicznie do powyższego zdjęcia z punktu 14a)
                </p>

                <p>
                    15) I – Obwód łydki w najszerszym miejscu łydki
                </p>
                <p className="m1">
                    a) Wyznaczamy miejsce, w którym łydka jest najszersza
                </p>
                <div className="page__images m1">
                    <img className="img" src={i35} alt="instrukcja" />
                </div>
                <p className="m1">
                    b) Centymetrem krawieckim mierzymy obwód w miejscu wyznaczonym w poprzednim punkcie (15a)
                </p>
                <div className="page__images m1">
                    <img className="img" src={i36} alt="instrukcja" />
                </div>
                <p className="m1">
                    c) Wykonujemy zdjęcie telefonem (analogicznie do powyższego zdjęcia z punktu 15b)
                </p>

                <p>
                    16) J – Wysokość łydki w najszerszym miejscu
                </p>
                <p className="m1">
                    a) Mierzymy wysokość od pięty do miejsca, w którym łydka jest najszersza (wyznaczonego w punkcie 15a niniejszej instrukcji)
                </p>
                <div className="page__images m1">
                    <img className="img" src={i37} alt="instrukcja" />
                </div>
                <p className="m1">
                    b) Wykonujemy zdjęcie telefonem (analogicznie do powyższego zdjęcia z punktu 16a)
                </p>

                <p>
                    17) K – Obwód pod kolanem (2 palce pod zagięciem kolana)
                </p>
                <p className="m1">
                    a) Upewniamy się, że kolano z łydką tworzą kąt prosty
                </p>
                <div className="page__images m1">
                    <img className="img" src={i38} alt="instrukcja" />
                </div>
                <p className="m1">
                    b) Przykładamy dwa palce tuż pod zgięciem pod kolanem i w wyznaczonym miejscu mierzymy obwód
                </p>
                <div className="page__images m1">
                    <img className="img--2" src={i39} alt="instrukcja" />
                ...
                <p className="m1 instruction--example">
                    Przykład 1:<br/>
                    Obwód w najszerszym miejscu łydki = 36 cm<br/>
                    Obwód pod kolanem = 33 cm<br/>
                    Różnica 36 cm – 33 cm = 3 cm<br/>
                    Powyższa różnica jest większa niż 3 cm, a więc obniżamy punkt mierzenia tak aby ta różnica wynosiła nie więcej niż 2 cm (zgodnie z rysunkiem b)
                </p>
                <p className="m1 instruction--example">
                    a)
                </p>
                <div className="page__images m1">
                    <img className="img" src={i41} alt="instrukcja" />
                </div>
                <p className="m1 instruction--example">
                    b)
                </p>
                <div className="page__images m1">
                    <img className="img" src={i42} alt="instrukcja" />
                </div>
                <p className="m1 instruction--example">
                    Przykład 2:<br/>
                    Obwód w najszerszym miejscu łydki = 34 cm<br/>
                    Obwód pod kolanem = 33 cm<br/>
                    Różnica 34 cm – 33 cm = 1 cm<br/>
                    Powyższa różnica jest mniejsza niż 2 cm, a więc podajemy 33 cm jako obwód pod kolanem
                </p>
                <div className="page__images m1">
                    <img className="img" src={i43} alt="instrukcja" />
                </div>
                <p className="m1">
                    d) Wykonujemy zdjęcie w miejscu wyznaczonym w powyższym punkcie (17c)
                </p>
                <div className="page__images m1">
                    <img className="img" src={i44} alt="instrukcja" />
                </div>
                ...
                <p className="m1">
                    b) Wykonujemy zdjęcie telefonem (analogicznie do powyższego zdjęcia z punktu 18a)
                </p>

                <p>
                    19) Wszystkie powyższe punkty powtarzamy dla stopy lewej
                </p>
...
export default InstructionType2;
